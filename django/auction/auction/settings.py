...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'react', 'auction', 'build')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=10), #later change to 5 minutes
    'REFRESH_TOKEN_LIFETIME': timedelta(days=30), #late change to 30 days
